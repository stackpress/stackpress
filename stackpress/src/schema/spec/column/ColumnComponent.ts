...
export default class ColumnComponent {
  ...
  /**
   * Returns the filter field attributes of the column
   */
  ...
  /**
   * Returns the form field attributes of the column
   */
  ...
  /**
   * Returns the list format attributes of the column
   */
  ...
  /**
   * Returns the span field attributes of the column
   */
  ...
  /**
   * Returns the view format attributes of the column
   */

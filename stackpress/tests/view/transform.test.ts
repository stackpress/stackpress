...
describe('view/transform', () => {
  it('should generate code files', async () => {
    ...
    // const form = path.join(paths.build, 'KitchenSink/components/form/ActiveFormField.tsx');
    // const filter = path.join(paths.build, 'KitchenSink/components/filter/CurrencyFilterField.tsx');
    // const list = path.join(paths.build, 'KitchenSink/components/list/ActiveListFormat.tsx');
    // const view = path.join(paths.build, 'KitchenSink/components/view/ActiveViewFormat.tsx');
    // const span = path.join(paths.build, 'KitchenSink/components/span/AgeSpanField.tsx');

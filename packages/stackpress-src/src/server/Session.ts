...
export default class Session {
  ...
  public readonly access: SessionPermissionList;
   ...
   */
  public constructor(name: string, seed: string, access: SessionPermissionList) {
    this.name = name;
    this.seed = seed;
   ...
   */
  public can(token: string, ...permits: SessionPermission[]) {
   ...
   * any of the permission patterns
   */
  protected _matchAnyRoute(permit: SessionRoute, permissions: SessionRoute[]) {
    //loop through permissions
    for (const permission of permissions) {
      //we just need one to match to 
      //say that this permit is valid
   ...
   * matches the permission pattern
   */
  protected _matchRoute(permit: SessionRoute, permission: SessionRoute) {

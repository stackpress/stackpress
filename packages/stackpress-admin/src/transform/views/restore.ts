...
export default function restoreView(directory: Directory, model: Model) {
  ...
  //export type AdminProfileRestoreHeadProps = AdminPageProps;
  source.addTypeAlias({
    isExported: true,
    name: model.name.toTypeName('%sAdminRestoreHeadProps'),
    type: 'AdminPageProps'
  });
  //export type AdminProfileRestorePageProps = AdminPageProps;
  source.addTypeAlias({
    isExported: true,
...
return (
  <div>
    ...
    <div className="actions">
      ...
      <a className="action restore" href={'?' + confirm.toString()}>

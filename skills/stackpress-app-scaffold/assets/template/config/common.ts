...
export const brand = {
  name: '__STACKPRESS_BRAND_NAME__',
  logo: '/logo.png',
  icon: '/icon.png',
  favicon: '/favicon.ico'
};
...
export const client = { 
  ...
  module: '__STACKPRESS_PACKAGE_NAME__-client',
  //name of the client package used in package.json
  package: '__STACKPRESS_PACKAGE_NAME__-client',
  ...
  build: path.join(cwd, 'node_modules', '__STACKPRESS_PACKAGE_NAME__-client'),

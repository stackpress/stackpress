...
export function Head(props: ServerPageProps<Config>) {
  ...
  const title = response.code === 404 ? _('Not Found') : _('Oops...');
  const description = response.code === 404 
...
export function Body() {
  ...
  return (
    <div>
      ...
      <p className="text-error px-p-10 rounded">
        <i className="px-mr-10 fas fa-fw fa-times-circle"></i>
        {description}
      </p>

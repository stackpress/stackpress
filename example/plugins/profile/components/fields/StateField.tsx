...
export function StateField(props: FieldProps) {
  //props
  ...
  return (
    <Input
      ...
      error={error}
      defaultValue={value}
      onUpdate={(value) => change && change("state", value)}
    />
  );
}

export function StateFieldControl(props: ControlProps) {
  //props
  ...
  //render
  return (
    <Control label={_("State")} error={error} className={className}>
      <StateField

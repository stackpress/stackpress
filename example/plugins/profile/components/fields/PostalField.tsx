...
export function PostalField(props: FieldProps) {
  //props
  ...
  return (
    <Input
      ...
      error={error}
      defaultValue={value}
      onUpdate={(value) => change && change("postal", value)}
    />
  );
}

export function PostalFieldControl(props: ControlProps) {
  //props
  ...
  //render
  return (
    <Control label={`${_("Postal Code")}*`} error={error} className={className}>
      <PostalField

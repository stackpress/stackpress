...
export function UnitField(props: FieldProps) {
  //props
  ...
  return (
    <Input
      ...
      error={error}
      defaultValue={value}
      onUpdate={(value) => change && change("unit", value)}
    />
  );
}

export function UnitFieldControl(props: ControlProps) {
  //props
  ...
  //render
  return (
    <Control label={_("Unit Number")} error={error} className={className}>
      <UnitField

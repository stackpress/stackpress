...
import { paginate, filter, order, notify, flash, Session, useStripe, Crumbs, Pagination, LayoutAdmin } from "stackpress/view";
        ...
        return (
          <aside className="theme-bg-bg2 theme-bc-bd1 flex flex-col px-w-100-0 px-h-100-0 border-r">
            ...
            <form className="flex-grow overflow-auto">
                    ...
                    <CreatedSpanControl 
                      className="px-mb-20"
                      value={query.span?.created} 
                    />
                  

                    <UpdatedSpanControl 
                      className="px-mb-20"
                      value={query.span?.updated} 
                    />
...
export function AdminProfileSearchResults(props: { query: Partial<SearchParams>, results: ProfileExtended[] }) {
...
export function AdminProfileSearchBody(props: PageBodyProps<AdminDataProps, Partial<SearchParams>, ProfileExtended[]>) {
        ...
        return (
          <main className="flex flex-col px-h-100-0 theme-bg-bg0 relative">
            ...
            <div className="px-p-10">
              <AdminProfileSearchForm root={root} token={session.token} open={open} can={can} />
            </div>
            {!!results?.length && (
...
export function AdminProfileSearchHead(props: PageHeadProps<AdminDataProps, Partial<SearchParams>, ProfileExtended[]>) {
...
export function AdminProfileSearchPage(props: PageBodyProps<AdminDataProps, Partial<SearchParams>, ProfileExtended[]>) {

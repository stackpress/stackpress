import type { NestedObject, PageHeadProps, PageBodyProps, AdminDataProps } from "stackpress/view";
...
export function AdminProfileUpdateCrumbs(props: { root: string, results: ProfileExtended }) {
...
export function AdminProfileUpdateBody(props: PageBodyProps<AdminDataProps,Partial<ProfileInput>,ProfileExtended>) {
...
export function AdminProfileUpdateHead(props: PageHeadProps<AdminDataProps,Partial<ProfileInput>,ProfileExtended>) {
...
export function AdminProfileUpdatePage(props: PageBodyProps<AdminDataProps,Partial<ProfileInput>,ProfileExtended>) {

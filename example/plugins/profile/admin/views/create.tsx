...
export function AdminProfileCreateBody(props: PageBodyProps<AdminDataProps, Partial<ProfileInput>, Profile>) {
...
export function AdminProfileCreateHead(props: PageHeadProps<AdminDataProps, Partial<ProfileInput>, Profile>) {
...
export function AdminProfileCreatePage(props: PageBodyProps<AdminDataProps, Partial<ProfileInput>, Profile>) {
